...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        apiService_country = ApiClient.getInstance(HomeActivity.this).getService_Country();
        apiService_vaccine = ApiClient.getInstance(HomeActivity.this).getService_Vaccine();
        init();
                ...
                sheetView.findViewById(R.id.pin_search_btn).setOnClickListener(new View.OnClickListener(){
                    ...
                    public void onClick(View v) {
                        if (TextUtils.isEmpty(pinCodeET.getText().toString())){
                            Toast.makeText(HomeActivity.this,"Please Enter PIN Code",Toast.LENGTH_SHORT).show();
                        }
                        else{
                            Toast.makeText(HomeActivity.this,"Search Button Clicked " + pinCodeET.getText().toString(),Toast.LENGTH_SHORT).show();
